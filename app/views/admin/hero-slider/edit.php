...
<head>
    ...
    <title>Edit Hero Slide - Admin Panel</title>
    ...
    <div class="admin-content">
        <div class="container-narrow">
            <div class="page-header">
                <h1>🖼️ Edit Hero Slide</h1>
                <p class="text-muted">Update hero slide details</p>
            </div>
            ...
            <div class="glass-card" style="margin-bottom: 20px;">
                <h3 style="margin-bottom: 15px;">Current Image</h3>
                <img src="<?= url('uploads/hero/' . htmlspecialchars($slide['image'])) ?>" 
                     alt="<?= htmlspecialchars($slide['image_alt'] ?: 'Current hero image') ?>"
                     style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            </div>

            <div class="glass-card">
                <form method="POST" action="<?= url('admin/hero-slider/update/' . $slide['id']) ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-muted">Leave empty to keep current image. Recommended: 1920x1080px, Max 5MB</small>
                        <div id="imagePreview" style="margin-top: 15px; display: none;">
                            <strong>New Image Preview:</strong>
                            <img id="preview" src="" alt="Preview" style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); margin-top: 10px;">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-muted">Leave empty to use default hero title</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" 
                                  ...
                                  class="form-control" 
                                  rows="3"
                                  placeholder="Override default hero description"><?= htmlspecialchars($slide['description']) ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               value="<?= htmlspecialchars($slide['image_alt']) ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               value="<?= htmlspecialchars($slide['button_url']) ?>">
                    ...
                    <div class="form-actions" style="display: flex; gap: 10px; margin-top: 30px;">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Update Hero Slide
                        </button>
