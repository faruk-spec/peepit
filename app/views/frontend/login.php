...
<div class="auth-container">
    <div class="auth-card glass-effect">
        <div class="auth-header">
            ...
            <h2>Welcome Back</h2>
            <p>Login to access your Peepit account</p>
        </div>
        ...
        <form method="POST" action="<?= url('login') ?>" id="login-form">
            ...
            <button type="submit" class="btn btn-primary btn-block water-drop-btn">
                <i class="fas fa-sign-in-alt"></i> Login to Peepit
            </button>
        </form>
        
        <div class="auth-footer">
            <p>Don't have an account? <a href="<?= url('register') ?>" class="link-primary">Register here</a></p>
        </div>
    </div>
